...
double moduloDivision(double num1, double num2) {
    if (num2 != 0) {
        return fmod(num1, num2);
    } else {
        printf("Error: Modulo division by zero is undefined.\n");
        return 0.0;
    }
}

int main() {
    double num1, num2, sum, difference, product, quotient, moduloResult;
    ...
    product = num1 * num2;
    quotient = num1 / num2;
    moduloResult = moduloDivision(num1, num2);
    ...
    printf("The result of modulo division is: %.2lf\n", moduloResult);
